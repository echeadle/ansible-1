This is the first example of building a server with ansible.  It will go step by step. The directory architectire is from the book Ansbile for Devops by Geerling. 
